...
df = pd.read_excel("C:\\Users\\mukes\\Desktop\\IBS2_endsem\\referenceCodon.xlsx", usecols="A")
reference = df.iloc[0][0]
reference = reference.split("+")

df1 = pd.read_excel("C:\\Users\\mukes\\Desktop\\IBS2_endsem\\sequenceCodon.xlsx", usecols="A")
